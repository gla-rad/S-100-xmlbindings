        ...
        for(T member : memberEntries) {
            switch (member) {
                ...
                case AtonAggregationImpl aggregation ->
                        members.getAtonAggregation().add(aggregation);
                case AtonAssociationImpl association ->
                        members.getAtonAssociation().add(association);
                ...
                case EmergencyWreckMarkingBuoyImpl buoyEmergencyWreckMarking ->
                        members.getEmergencyWreckMarkingBuoy().add(buoyEmergencyWreckMarking);
